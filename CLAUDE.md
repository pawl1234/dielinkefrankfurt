...
- TypeScript 5.9.2 (strict mode) + Next.js 15.4.6 (App Router), React 19.2.0, Material UI 7.3.1, Prisma 6.13.0, NextAuth.js 4.24.11, React Hook Form 7.62.0, Zod 4.0.17 (011-group-user-membership)

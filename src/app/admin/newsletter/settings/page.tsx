...
import { NEWSLETTER_LIMITS, STATUS_REPORT_LIMITS } from '@/lib/newsletter';
import { DEFAULT_AI_SYSTEM_PROMPT, DEFAULT_AI_VORSTANDSPROTOKOLL_PROMPT, DEFAULT_TOPIC_EXTRACTION_PROMPT } from '@/lib/ai';

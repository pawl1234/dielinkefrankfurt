...
function validateSchema() {
  try {
    console.log('📝 Validating schema.prisma configuration...');
    ...
    if (updated) {
      ...
      console.log('✅ Updated schema.prisma configuration');
    } else {
...
CREATE TABLE IF NOT EXISTS "Appointment" (
    ...
    console.log('✅ Fresh migration created at', newMigrationDir);
    return true;
  } catch (error) {
...
async function resetDatabase() {
  try {
    console.log('🗑️ Attempting to reset PostgreSQL database...');
